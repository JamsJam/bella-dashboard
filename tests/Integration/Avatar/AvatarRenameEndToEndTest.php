...
namespace App\Tests\Integration\Avatar;
...
#[Group('integration')]
final class AvatarRenameEndToEndTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        if (!str_ends_with($databaseName, '_test')) {
            self::fail(sprintf('Refusing to run avatar integration test against non-test database "%s".', $databaseName));
        }
