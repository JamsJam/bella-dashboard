...
final class ClotheService
{
     ...
     */
    public function getCategoriesByName(): array
    {
        return $this->clotheProvider->findCategoriesByName();
    }

    /**
     * @return list<Collections>
     */
    public function getCollectionsByName(): array
    {
        return $this->clotheProvider->findCollectionsByName();
    }

    /**
     * @param list<ClothesVariant> $variants
     *
     * @return list<array{variant: ClothesVariant, transitions: array}>
     */
    public function getVariantWorkflows(array $variants): array
    {
        return array_map(
            fn (ClothesVariant $variant): array => [
                'variant' => $variant,
                'transitions' => $this->workflowService
                    ->getEnabledTransitions($variant),
            ],
            $variants,
        );
    }
     ...
     * @param list<ClothesVariant> $variants
     */
    public function hasPublishableVariant(array $variants): bool
    {
